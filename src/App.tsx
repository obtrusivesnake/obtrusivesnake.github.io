...
function ImagePlaceholder({
    ...
    return (
        <div
            className={`bg-stone-900 flex items-center justify-center aspect-[4/3] overflow-hidden border border-white/10 ${className}`}
        >
            <div className="text-center p-6">
                <svg
                    className="w-12 h-12 mx-auto mb-3 text-stone-700"
                    fill="none"
                    viewBox="0 0 24 24"
                    strokeWidth={1}
                    stroke="currentColor"
